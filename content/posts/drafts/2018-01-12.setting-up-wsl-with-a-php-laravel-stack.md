...
Recently, I've been toying around with the use of WSL (Windows Subsystem for Linux) for development. I've used a Mac, exclusively, for development work over better part of the last decade, as my love depreciates a little, I wanted to try setup my gaming PC to see if I could mimic my development environemnt. 
...
1. First things first, you're going to need to enable the Windows Subsytem for Linux, to do this use "Turn Windows features on or off" and select "Windows Subsystem for Linux" to enable it, click OK, reboot, and use this app. For more information on this you can view the [Microsoft Documentation](https://docs.microsoft.com/en-us/windows/wsl/install-win10).
